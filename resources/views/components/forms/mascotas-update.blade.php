        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid bd-example-row">
                    <form class="row g-3" id="formMascotasUpdate" action="" method="post">
                        @method('PUT')
                        @csrf
                        <div class="row mt-2">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <div class="row px-5">
                                            <div class="col-sm-5 form-check pl-2">
                                                <input class="form-check-input" type="radio" id="sexoMacho"
                                            ...
                                            <div class="col-sm-5 form-check">
                                                <input class="form-check-input" type="radio" id="sexoHembra"
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <textarea type="text" class="form-control" form="formMascotasUpdate" id="descripcion" placeholder="Zona, Avenida, calle" name="descripcion">
                                        </textarea>
            ...
            <div class="modal-footer">
                ...
                <button type="submmit" form="formMascotasUpdate" class="btn btn-danger btn-lg">Guardar Datos</button>
            </div>
        </div>
    </div>
</div>
